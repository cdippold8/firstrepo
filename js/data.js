...
const RECIPES = {
  ...
  bulkChickenStew: {
    name: "Slow-Simmered White Bean & Chicken Stew (Bulk — 2 nights)",
    servings: "6 servings (2 dinners for 2 people + leftovers)",
    seasonal: "Late-summer tomatoes with hearty greens",
    bulk: true,
    cholesterolTip: "Skinless chicken breast + white beans keeps saturated fat low, and the soluble fiber from the beans helps lower LDL.",
    ingredients: [
    ...
    steps: [
      "Heat olive oil in a large pot over medium heat. Season chicken with salt and pepper; brown 5–6 min. Remove and set aside.",
      "Add onion, carrot, and celery to the pot; cook 5 min until softened. Add garlic, cook 1 min more.",
      "Stir in beans, tomatoes, broth, rosemary, and thyme. Return chicken to the pot. Bring to a simmer and cook uncovered 25–30 min until chicken is cooked through and vegetables are tender.",
      "Stir in spinach or kale during the last 3–4 min, just until wilted. Season with salt and pepper.",
      "Serve half tonight; refrigerate the rest for the repeat dinner later this week.",
    ],
  },
  bulkMinestrone: {
  ...
  balsamicChicken: {
    name: "Sheet-Pan Balsamic Chicken with Peppers & Charred Corn",
    servings: "2 servings",
    seasonal: "Bell peppers and sweet corn are at their best in August",
    cholesterolTip: "Skinless chicken breast and a balsamic-olive oil glaze instead of a creamy or buttery sauce.",
    ingredients: [
      "2 boneless, skinless chicken breasts",
      "2 bell peppers, sliced",
      "2 ears corn, cut into rounds (or 1.5 cups kernels)",
      "1 red onion, sliced",
    ...
    steps: [
      "Preheat oven to 425°F. Whisk 2 tbsp olive oil, balsamic vinegar, honey, garlic, oregano, salt, and pepper.",
      "Toss peppers, corn, and onion with remaining olive oil on a sheet pan. Nestle chicken breasts among the vegetables and brush everything with the balsamic mixture.",
      "Roast 22–25 min, brushing once more halfway through, until chicken reaches 165°F and vegetables are lightly charred.",
      "Let chicken rest 5 min, slice, and serve over the roasted vegetables.",
    ],
  },
  blackenedCod: {
  ...
  A: {
    ...
    days: {
      Monday: {
        ...
        dinner: { name: RECIPES.balsamicChicken.name, kcal: 480, recipeId: "balsamicChicken" },
      },
      Tuesday: {
        ...
        dinner: { name: RECIPES.bulkChickenStew.name, kcal: 460, recipeId: "bulkChickenStew", bulk: true, bulkNote: "Cook the full batch tonight — repeats Thursday." },
      },
      Wednesday: {
      ...
      Thursday: {
        ...
        dinner: { name: RECIPES.bulkChickenStew.name + " (leftovers)", kcal: 460, recipeId: "bulkChickenStew", bulk: true, bulkNote: "Reheat Tuesday's batch — no cooking tonight." },
      },
      Friday: {
